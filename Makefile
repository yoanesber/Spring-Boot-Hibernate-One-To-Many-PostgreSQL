...
APP_CONTAINER_IMAGE=my-one-to-many-app
APP_CONTAINER_NAME=one-to-many-app
APP_DOCKER_CONTEXT=.
APP_DOCKERFILE=./src/main/docker/app/Dockerfile
APP_PORT=8081

# Variables for the PostgreSQL container
POSTGRES_CONTAINER_IMAGE=my-one-to-many-postgres
POSTGRES_CONTAINER_NAME=one-to-many-postgres
